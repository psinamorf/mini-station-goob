...
public sealed class RatvarPowerObjectiveSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<RatvarPowerObjectiveComponent, ObjectiveAssignedEvent>(OnAssigned);
        SubscribeLocalEvent<RatvarPowerObjectiveComponent, ObjectiveAfterAssignEvent>(OnAfterAssigned);
