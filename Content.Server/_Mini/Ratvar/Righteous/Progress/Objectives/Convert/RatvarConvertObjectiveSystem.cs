...
public sealed class RatvarConvertObjectiveSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<RatvarConvertObjectiveComponent, ObjectiveAssignedEvent>(OnAssigned);
        SubscribeLocalEvent<RatvarConvertObjectiveComponent, ObjectiveAfterAssignEvent>(OnAfterAssigned);
