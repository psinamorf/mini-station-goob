...
public sealed class ERTCallSystem : EntitySystem
{
    ...
    private const string CallAnnouncementSound = "/Audio/_Mini/Announcements/ERT/call.ogg";
    private const string DecisionAnnouncementSound = "/Audio/_Mini/Announcements/ERT/decision.ogg";
    private const string RecallAnnouncementSound = "/Audio/_Mini/Announcements/ERT/recall.ogg";
    private const string SpawnAnnouncementSound = "/Audio/_Mini/Announcements/ERT/spawn.ogg";
